...
public fun AppPreview() {
    ...
    App(remember { TopicViewModel(scope) }, remember { FavoritesViewModel(scope) })
}
...
public class BrowserHandler {
    private val app: CefApp by lazy {
    ...
    private val client: CefClient by lazy { app.createClient() }
