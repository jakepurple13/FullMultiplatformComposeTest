...
@Suppress("unused")
internal val M3MaterialTheme.spacing: Spacing
    @Composable
    @ReadOnlyComposable
    get() = LocalThemeSpacing.current
...
@Composable
internal fun ColorScheme.animate() = copy(
...
public enum class ThemeColors(
    ...
    public fun getTheme(darkTheme: Boolean): Colors = if (darkTheme) dark else light
    public fun getThemeScheme(darkTheme: Boolean): ColorScheme = if (darkTheme) darkScheme else lightScheme
}
