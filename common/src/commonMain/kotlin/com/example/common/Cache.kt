...
@DslMarker
internal annotation class GenericCacheMarker
...
internal interface GenericCache<K, V> {
    */
/**
...
internal class ExpirableLRUCache<K, V>(
    private val minimalSize: Int = DEFAULT_SIZE,
    private val flushInterval: Long = 1,
